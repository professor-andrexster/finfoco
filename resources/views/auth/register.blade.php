...
<div style="width:100%;max-width:420px">
    ...
    <div class="card">
        <h1 style="font-size:22px;font-weight:700;margin-bottom:6px">Crie sua conta</h1>
        <p style="color:#9794B8;font-size:14px;margin-bottom:28px">Comece a organizar suas finanças agora.</p>
        ...
        <form action="{{ route('register') }}" method="POST" style="display:flex;flex-direction:column;gap:18px">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       placeholder="Como quer ser chamado?" autocomplete="name" autofocus required>
            </div>
            <div>
                <label>E-mail</label>
